...
import { ConvocModule } from './convoc.module';
...
async function bootstrap() {
  const app = await NestFactory.create<NestExpressApplication>(ConvocModule);
  ...
  await app.listen(configService.get<string>('PORT') ?? 3008);
}
